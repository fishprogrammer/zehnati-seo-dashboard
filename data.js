...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-03T14:03:16+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۳ · ۱۴:۰۳",
    status: "critical",
    summaryFa: "۱۲/۱۳ صفحه 200 · مشکل robots/sitemap · P0 خراب: / · ۳ هشدار drift · بحرانی",
    pagesOk: 12,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: false,
    alerts: [{"level": "critical", "path": "/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/", "message": "صفحه P0 وضعیت HTTP 0 دارد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "pass", detail: "موجود · sitemap ref ✓ · Sentinel 14:03" },
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 404 · Sentinel 14:03" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 03 Sep: 12/13 OK · P0 نیاز بررسی" },
