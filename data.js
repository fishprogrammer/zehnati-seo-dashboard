...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-20T19:00:05+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۲۰ · ۱۹:۰۰",
    status: "critical",
    summaryFa: "۱۲/۱۳ صفحه 200 · مشکل robots/sitemap · P0 خراب: /برنامه-ریزی-کنکور/ · ۳ هشدار drift · بحرانی",
    pagesOk: 12,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: false,
    alerts: [{"level": "critical", "path": "/برنامه-ریزی-کنکور/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/برنامه-ریزی-کنکور/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/برنامه-ریزی-کنکور/", "message": "صفحه P0 وضعیت HTTP 0 دارد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 20 Sep: 12/13 OK · P0 نیاز بررسی" },
