...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-04T14:01:31+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۴ · ۱۴:۰۱",
    status: "critical",
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "fail", detail: "خطا · sitemap ref ✗ · Sentinel 14:01" },
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 0 · Sentinel 14:01" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 04 Sep: 0/13 OK · P0 نیاز بررسی" },
