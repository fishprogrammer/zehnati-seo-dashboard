...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-08-24T14:00:09+03:30",
    checkedAtFa: "۲۰۲۶-۰۸-۲۴ · ۱۴:۰۰",
    status: "critical",
    summaryFa: "۱۲/۱۳ صفحه 200 · robots+sitemap OK · P0 خراب: / · ۲ هشدار drift · بحرانی",
    pagesOk: 12,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: true,
    alerts: [{"level": "warn", "path": "/about/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "critical", "path": "/", "message": "صفحه P0 وضعیت HTTP 0 دارد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 24 Aug: 12/13 OK · P0 نیاز بررسی" },
