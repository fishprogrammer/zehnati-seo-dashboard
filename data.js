...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-03T19:00:11+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۳ · ۱۹:۰۰",
    status: "critical",
    summaryFa: "۱۳/۱۳ صفحه 200 · مشکل robots/sitemap · ۱ هشدار drift · بحرانی",
    pagesOk: 13,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: false,
    alerts: [{"level": "warn", "path": "/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 03 Sep: 13/13 OK · P0 سالم" },
