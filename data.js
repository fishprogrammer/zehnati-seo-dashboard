...
window.ZEHNATI_SEO = {
  ...
  score: {
    overall: 66,
    label: "آدیت ۲۲ جولای: 66/۱۰۰ — ۵ لندینگ P0 · CTA خانه · تجربی 1 H1 ✓",
    breakdown: [
      { id: "tech", name: "فنی", score: 74, max: 100 },
      { id: "onpage", name: "آن‌پیج", score: 72, max: 100 },
      { id: "content", name: "محتوا", score: 52, max: 100 },
      { id: "local", name: "محلی", score: 58, max: 100 },
      { id: "conversion", name: "تبدیل / Landing", score: 66, max: 100 },
    ],
  },
  kpis: [
  ...
  techStatus: [
    ...
    { id: "landings", name: "Landingهای P0", status: "warn", detail: "قیمت+هاب+اصفهان+آنلاین 200/۱H1 · تهران/ثبت‌نام باز" },
    {
      id: "gsc-site",
      name: "GSC کل سایت",
      status: "pass",
