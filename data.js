...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-18T15:28:48+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۱۸ · ۱۵:۲۸",
    status: "critical",
    ...
    robotsOk: false,
    sitemapOk: false,
    alerts: [{"level": "critical", "path": "/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/about/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/about/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/contact-us/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/contact-us/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/auth/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "critical", "path": "/مشاوره-کنکور/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
    "updatedAt": "2026-09-17T15:30:14+03:30",
    "updatedAtFa": "۱۴۰۵/۰۶/۲۶ · ۱۵:۳۰",
    "category": {
      "name": "مقالات",
      "slug": "blogs",
      "total": 220
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "fail", detail: "خطا · sitemap ref ✗ · Sentinel 15:28" },
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 0 · Sentinel 15:28" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 18 Sep: 0/13 OK · P0 نیاز بررسی" },
