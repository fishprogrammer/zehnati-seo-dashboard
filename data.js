...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-08-31T19:37:04+03:30",
    checkedAtFa: "۲۰۲۶-۰۸-۳۱ · ۱۹:۳۷",
    status: "critical",
    summaryFa: "۱۳/۱۳ صفحه 200 · مشکل robots/sitemap · بحرانی",
    pagesOk: 13,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: false,
  ...
  techStatus: [
    ...
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 404 · Sentinel 19:37" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 31 Aug: 13/13 OK · P0 سالم" },
