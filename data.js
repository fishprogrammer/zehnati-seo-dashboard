...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-10T14:38:31+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۱۰ · ۱۴:۳۸",
    status: "warn",
    summaryFa: "۱۳/۱۳ صفحه 200 · robots+sitemap OK · ۱۲ هشدار drift · هشدار",
    pagesOk: 13,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: true,
    alerts: [{"level": "warn", "path": "/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/about/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/contact-us/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/قیمت-مشاوره-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/بهترین-مشاور-کنکور-اصفهان/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-آنلاین-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-کنکور-تجربی/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
    ...
    "daily": [
      ...
      },
      {
        ...
        "entries": [
          {
            "at": "2026-08-30T18:25:34+03:30",
            "atFa": "۱۴۰۵/۰۶/۰۸ · ۱۸:۲۵",
            "dryRun": false,
            "processed": 3,
            "optimized": 3,
            "results": [
              ...
              {
                "postId": 7705,
                "title": "روش خواندن گسسته برای کنکور + راهکار",
                "link": "https://zehnati.ir/%d8%b1%d9%88%d8%b4-%d8%ae%d9%88%d8%a7%d9%86%d8%af%d9%86-%da%af%d8%b3%d8%b3%d8%aa%d9%87-%d8%a8%d8%b1%d8%a7%db%8c-%da%a9%d9%86%da%a9%d9%88%d8%b1-%d8%b1%d8%a7%d9%87%da%a9%d8%a7%d8%b1/",
                "issuesBefore": [
                  "missing_focus_keyword",
                  "missing_seo_title",
                  "missing_meta_description",
              ...
              {
                "postId": 7708,
                "title": "روش خواندن درس شیمی کنکور",
                "link": "https://zehnati.ir/%d8%b1%d9%88%d8%b4-%d8%ae%d9%88%d8%a7%d9%86%d8%af%d9%86-%d8%af%d8%b1%d8%b3-%d8%b4%db%8c%d9%85%db%8c-%da%a9%d9%86%da%a9%d9%88%d8%b1/",
                "issuesBefore": [
                  "missing_focus_keyword",
                  "missing_seo_title",
                  "missing_meta_description"
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "pass", detail: "موجود · sitemap ref ✓ · Sentinel 14:38" },
    { id: "sitemap", name: "XML Sitemap", status: "pass", detail: "sitemap_index.xml = 200 · Sentinel 14:38" },
    ...
    { id: "landings", name: "Landingهای P0", status: "warn", detail: "Sentinel 10 Sep: 13/13 OK · P0 سالم" },
  ...
  goldenKeywords: [
    ...
    { kw: "مشاوره کنکور", page: "/مشاوره-کنکور/", status: "mapped", note: "GSC ۳ماه: ۱۰ کلیک / ۳۸۷ نمایش / رتبه ~۱۱.۹" },
    {
      kw: "بهترین مشاور کنکور اصفهان",
      page: "/بهترین-مشاور-کنکور-اصفهان/",
      status: "mapped",
  ...
  keywordCoveragePlan: [
    ...
    { month: 2, phase: 2, p0: 28, p1: 0, p2: 0, p3: 0, note: "تکمیل P0 ✓ + Silo ✓ + Site Checkup QW" },
    { month: 3, phase: 3, p0: 0, p1: 30, p2: 0, p3: 0, note: "P1 دسته۱ + اعتماد/AI Vis" },
    { month: 4, phase: 4, p0: 0, p1: 15, p2: 0, p3: 0, note: "لوکال + CWV Site Checkup" },
    { month: 5, phase: 5, p0: 0, p1: 30, p2: 0, p3: 0, note: "P1 دسته۲ + عمق محتوا" },
  ...
  existingPages: [
    ...
    { url: "/مشاوره-کنکور/", title: "هاب مشاوره کنکور" },
    { url: "/قیمت-مشاوره-کنکور/", title: "قیمت مشاوره کنکور" },
    { url: "/مشاوره-تحصیلی-در-اصفهان/", title: "مشاوره تحصیلی در اصفهان (قوی در GSC)" },
  ...
  phaseDetails: {
    ...
    1: {
      ...
      actions: [
        ...
        },
        {
          ...
          where: "Landing جدید",
          why: "لایو: 200 · ۱ H1 · landing-online · FAQ · EducationalOrganization",
          done: true,
        },
        {
          id: "p1-a4",
          ...
          where: "صفحه جدید + ۳۰۱ از بلاگ ۱۷ H1",
          why: "لایو: 200 · ۱ H1 · landing-isfahan · FAQ · ۳۰۱ بلاگ و /مشاوره-کنکور-در-اصفهان/",
          done: true,
        },
        {
          id: "p1-a5",
          ...
          where: "وردپرس",
          why: "✅ لایو: /بهترین-مشاور-کنکور-تهران/ · 200 · 1 H1 · landing-tehran · FAQ · فاطمی/021",
          done: true,
        },
        {
          id: "p1-a6",
          ...
          why: "✅ لایو 22 Jul: 1 H1 · محتوا جدید · Posts Title→H3",
          done: true,
        },
        {
          id: "p1-a7",
          priority: "medium",
          title: "نویسنده وردپرس = fishprogrammer",
          where: "وردپرس کاربر / Rank Math",
          why: "✅ عمدی: نویسنده شماست (نه دکتر جعفری) · Person/بایو دکتر جعفری جدا از author WP",
          done: true,
        },
        {
          id: "p1-a8",
        ...
        },
        {
          ...
          why: "✅ 25/25 ماه۱ → URL · وضعیت پوشش-ماه۱ · month1-p0-coverage-map.md",
          done: true,
        },
        {
          id: "p1-a10",
          ...
          why: "✅ Request indexing (تهران+P0) · گزارش: SEO/05-tracking/month1-report-1405-04.md · ۷ مرداد",
          done: true,
        },
        {
          id: "p1-a11",
          priority: "critical",
          title: "پاکسازی ۶۱×۴۰۴ GSC (Rank Math)",
          where: "Rank Math Redirections",
          why: "✅ 64 ریدایرکت 301 لایو · تست 64/64 · Validate GSC 21 Jul · re-crawl",
          done: true,
        },
        {
          id: "p1-a13",
      ...
      checklist: [
        ...
        { id: "p1-c3", label: "لندینگ مشاوره آنلاین (200)", done: true },
        ...
        { id: "p1-c10", label: "گزارش ماه ۱ آماده", done: true },
      ],
    },
    2: {
      ...
      actions: [
        {
          ...
          note: "۲۰۲۶-۰۸-۲۶: ویجت CTA تجاری · ۲۰۲۶-۰۸-۲۷ تأیید لایو · بدون /auth/ · ۵ لینک P0 روی خانه",
        },
        {
          id: "p2-a2",
          priority: "high",
        ...
        },
        {
          ...
          note: "۲۰۲۶-۰۸-۲۸: /مشاوره-کنکور-ریاضی/ + /مشاوره-کنکور-انسانی/ · ۱ H1 · محتوا هم‌تراز تجربی · ریدایرکت URL قدیمی ریاضی",
        },
        {
          id: "p2-a5",
          priority: "medium",
    ...
    3: {
      ...
      actions: [
        ...
        },
        {
          id: "p3-a8",
          priority: "high",
          title: "بخش نتایج: ۱–۲ داستان موفقیت با attribution",
          where: "خانه یا /satisfaction/",
          why: "Credibility پایین · اثبات ادعای رتبه برتر",
          done: false,
          note: "منبع: Content Opportunities Site Checkup",
        },
        {
          id: "p3-a3",
          priority: "medium",
        ...
        },
        {
          id: "p3-a4",
          priority: "high",
          title: "llms.txt + صفحات قابل استناد برای AI Visibility",
          where: "ریشه سایت / راهنماها",
          why: "AI Visibility الان ۵۹/۱۰۰ · برند کم در ChatGPT/Gemini/Perplexity",
          done: false,
          note: "منبع: SEO Site Checkup AI Visibility 59",
        },
        {
          id: "p3-a5",
          priority: "high",
    ...
    4: {
      ...
      actions: [
        ...
        },
        {
          id: "p4-a5",
          priority: "critical",
          title: "CWV خانه: FCP≤۱.۸s · کاهش render-blocking",
          where: "LiteSpeed · صفحه اصلی",
          why: "Site Checkup HIGH · FCP 2.24s · Speed score 68 · 85 HTTP request",
          done: false,
          note: "منبع: Render Blocking + Page Objects + FCP tests 2026-09-07",
        },
        {
          id: "p4-a9",
          priority: "critical",
          title: "تصاویر مدرن WebP/AVIF + اندازهٔ مناسب viewport",
          where: "مدیا خانه + LiteSpeed Image Optimize",
          why: "Site Checkup HIGH/MEDIUM · JPEG خام · oversized · aspect ratio",
          done: false,
          note: "Modern Image Format + Responsive Image + Aspect Ratio failed",
        },
        {
          id: "p4-a4",
          priority: "high",
          title: "alt توصیفی برای همه imgهای خانه (و قالب‌های مشترک)",
          where: "Elementor / مدیا",
          why: "Site Checkup HIGH · Image Alt Test failed",
          done: false,
          note: "قبلاً ۱۵/۱۶ بدون alt گزارش شده بود؛ با checkup جدید هم‌راستا شود",
        },
        {
          id: "p4-a10",
          priority: "high",
          title: "Minify JS + کاهش درخواست‌های CSS/JS (هدف ≪۸۵)",
          where: "LiteSpeed Cache",
          why: "Site Checkup MEDIUM · JS minify fail · ۴۰ CSS + ۲۷ JS",
          done: false,
        },
        {
          id: "p4-a3",
          ...
          why: "یافته technical audit · HSTS الان هست؛ تکمیل بقیه",
          done: false,
        },
        {
          id: "p4-a11",
          priority: "medium",
          title: "کاهش HTML سنگین خانه (Elementor / ویجت‌های تکراری)",
          where: "صفحه اصلی",
          why: "Site Checkup LOW · HTML 53KB uncompressed path / DOM شلوغ تجربه",
          done: false,
        },
        {
          id: "p4-a6",
        ...
        },
        {
          id: "p4-a8",
          priority: "medium",
          title: "گزارش ماه ۴ · تجمعی ۹۸/۲۰۶ + PSI قبل/بعد",
          where: "داشبورد",
      ...
      checklist: [
        ...
        { id: "p4-c8", label: "WebP + اندازهٔ درست تصاویر خانه", done: false },
        { id: "p4-c9", label: "Render-blocking / FCP بهبود یافت", done: false },
        { id: "p4-c10", label: "JS minify + کاهش requestها", done: false },
    ...
    5: {
      ...
      status: "upcoming",
      goal: "۳۰ کیورد P1 · رصد رقبا · عمق موضوعی برند",
      kwTarget: { p0: 0, p1: 30, p2: 0, p3: 0, total: 30 },
      actions: [
        {
          id: "p5-a1",
        ...
        },
        {
          id: "p5-a6",
          priority: "high",
          title: "عمق آموزشی هاب‌ها: راهنمای تصمیم والدین/داوطلب",
          where: "هاب مشاوره + خانه",
          why: "Site Checkup: Limited Educational Depth · Content Trust 56٪",
          done: false,
          note: "منبع: Domain Business Context / Content Weaknesses",
        },
        {
          id: "p5-a7",
          priority: "medium",
          title: "تاریخ به‌روزرسانی نمایان روی صفحات ستون",
          where: "لندینگ‌ها / مقالات P0",
          why: "Content Freshness · Staleness: بدون publish/update date",
          done: false,
        },
        {
          id: "p5-a3",
          ...
          where: "خارج از سایت",
          why: "نه رپورتاژ اسپم · کمک به AI mention",
          done: false,
        },
        {
          id: "p5-a4",
      ...
      checklist: [
        ...
        { id: "p5-c5", label: "عمق آموزشی هاب‌ها تقویت شد", done: false },
        { id: "p5-c6", label: "تاریخ به‌روزرسانی روی صفحات ستون", done: false },
    ...
    6: {
      ...
      actions: [
        ...
        },
        {
          id: "p6-a5",
          priority: "low",
          title: "مخفی‌سازی ایمیل plaintext از HTML عمومی",
          where: "خانه / فوتر / تماس",
          why: "Site Checkup: plaintext email harvest risk",
          done: false,
          note: "اولویت پایین؛ ads.txt لازم نیست (سایت تبلیغ‌فروش نیست)",
        },
        {
          id: "p6-a4",
          priority: "high",
      ...
      checklist: [
        ...
        { id: "p6-c5", label: "ایمیل plaintext محافظت شد", done: false },
    ...
    7: {
      ...
      actions: [
        ...
        },
        {
          id: "p7-a7",
          priority: "high",
          title: "Site Checkup مجدد · هدف SEO≥۸۵ و AI Visibility≥۷۰",
          where: "seositecheckup.com یا معادل",
          why: "بستن حلقه یافته‌های سپتامبر ۲۰۲۶ (۷۷ / ۵۹)",
          done: false,
          note: "مقایسه با آرشیو 2026-09-07",
        },
        {
          id: "p7-a4",
          priority: "high",
      ...
      checklist: [
        ...
        { id: "p7-c7", label: "Site Checkup ≥۸۵ / AI Vis ≥۷۰", done: false },
