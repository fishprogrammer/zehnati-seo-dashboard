...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-05T19:00:05+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۵ · ۱۹:۰۰",
    status: "critical",
    summaryFa: "۴/۱۳ صفحه 200 · مشکل robots/sitemap · P0 خراب: /، /مشاوره-کنکور/، /قیمت-مشاوره-کنکور/ · ۲۳ هشدار drift · بحرانی",
    pagesOk: 4,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: false,
  ...
  techStatus: [
    ...
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 404 · Sentinel 19:00" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 05 Sep: 4/13 OK · P0 نیاز بررسی" },
