...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-12T14:00:12+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۱۲ · ۱۴:۰۰",
    status: "critical",
    summaryFa: "۸/۱۳ صفحه 200 · robots+sitemap OK · P0 خراب: /، /مشاوره-کنکور/ · ۱۰ هشدار drift · بحرانی",
    pagesOk: 8,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: true,
    alerts: [{"level": "warn", "path": "/قیمت-مشاوره-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/بهترین-مشاور-کنکور-اصفهان/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-آنلاین-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-کنکور-تجربی/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-تحصیلی-در-اصفهان/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/ثبت-نام/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/بهترین-مشاور-کنکور-تهران/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}, {"level": "warn", "path": "/برنامه-ریزی-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 12 Sep: 8/13 OK · P0 نیاز بررسی" },
