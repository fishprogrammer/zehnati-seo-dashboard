...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-21T14:00:15+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۲۱ · ۱۴:۰۰",
    status: "warn",
    summaryFa: "۱۳/۱۳ صفحه 200 · robots+sitemap OK · ۱ هشدار drift · هشدار",
    pagesOk: 13,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: true,
    alerts: [{"level": "warn", "path": "/برنامه-ریزی-کنکور/", "message": "تعداد H1 از 0 به 1 تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "landings", name: "Landingهای P0", status: "warn", detail: "Sentinel 21 Sep: 13/13 OK · P0 سالم" },
