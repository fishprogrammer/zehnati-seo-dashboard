...
window.ZEHNATI_SEO = {
  ...
  score: {
    overall: 73,
    label: "آدیت ۲۲ اوت: 73/۱۰۰ — GSC 3m 15٬565 کلیک · WoW +12.8٪ · P0 کلیک~128",
    breakdown: [
  ...
  gsc: {
    ...
    "opportunities": [
      {
        "kw": "کنکور فنی حرفه ای",
        "impressions": 432,
        "position": 8.59,
        "note": "فرصت محتوا/لندینگ"
      },
      {
        "kw": "کارنامه قبولی داروسازی",
        "impressions": 111,
        "position": 8.58,
        "note": "فرصت محتوا/لندینگ"
      },
  ...
  gscWow: {
    ...
    "insights": [
      "کلیک هفته: 1108 در برابر 982 (+12.8٪).",
      "نمایش هفته: 9613 در برابر 8225 (+16.9٪).",
      "WoW مثبت هفته ۷–۱۳ اوت را با لینک داخلی و CTR هاب حفظ کنید.",
  ...
  techStatus: [
    ...
    { id: "gsc-site", name: "GSC کل سایت", status: "warn", detail: "آدیت 22 Aug: 73 · GSC 3m 15٬565 کلیک · P0 کلیک~128" },
