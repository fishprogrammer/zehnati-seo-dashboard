...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-06T14:00:06+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۶ · ۱۴:۰۰",
    status: "critical",
    ...
    robotsOk: false,
    sitemapOk: false,
    alerts: [{"level": "critical", "path": "/مشاوره-تحصیلی-در-اصفهان/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/مشاوره-تحصیلی-در-اصفهان/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/ثبت-نام/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/ثبت-نام/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/بهترین-مشاور-کنکور-تهران/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/بهترین-مشاور-کنکور-تهران/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}, {"level": "critical", "path": "/برنامه-ریزی-کنکور/", "message": "وضعیت HTTP از 200 به 0 تغییر کرد"}, {"level": "warn", "path": "/برنامه-ریزی-کنکور/", "message": "تعداد H1 از 1 به 0 تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "fail", detail: "خطا · sitemap ref ✗ · Sentinel 14:00" },
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 0 · Sentinel 14:00" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 06 Sep: 0/13 OK · P0 نیاز بررسی" },
