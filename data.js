...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-02T15:18:24+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۲ · ۱۵:۱۸",
    status: "critical",
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "fail", detail: "خطا · sitemap ref ✗ · Sentinel 15:18" },
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 0 · Sentinel 15:18" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 02 Sep: 0/13 OK · P0 نیاز بررسی" },
