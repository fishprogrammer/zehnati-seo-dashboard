...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-22T19:23:34+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۲۲ · ۱۹:۲۳",
    status: "critical",
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "fail", detail: "خطا · sitemap ref ✗ · Sentinel 19:23" },
    { id: "sitemap", name: "XML Sitemap", status: "fail", detail: "sitemap_index.xml = 0 · Sentinel 19:23" },
    ...
    { id: "landings", name: "Landingهای P0", status: "fail", detail: "Sentinel 22 Sep: 0/13 OK · P0 نیاز بررسی" },
