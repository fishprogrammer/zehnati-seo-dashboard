...
window.ZEHNATI_SEO = {
  ...
  dailyHealth: {
    checkedAt: "2026-09-07T19:54:09+03:30",
    checkedAtFa: "۲۰۲۶-۰۹-۰۷ · ۱۹:۵۴",
    status: "warn",
    summaryFa: "۱۳/۱۳ صفحه 200 · robots+sitemap OK · ۶ هشدار drift · هشدار",
    pagesOk: 13,
    pagesTotal: 13,
    robotsOk: true,
    sitemapOk: true,
    alerts: [{"level": "warn", "path": "/قیمت-مشاوره-کنکور/", "message": "title تغییر کرد"}, {"level": "warn", "path": "/مشاوره-آنلاین-کنکور/", "message": "title تغییر کرد"}, {"level": "warn", "path": "/مشاوره-کنکور-تجربی/", "message": "title تغییر کرد"}, {"level": "warn", "path": "/ثبت-نام/", "message": "title تغییر کرد"}, {"level": "warn", "path": "/بهترین-مشاور-کنکور-تهران/", "message": "title تغییر کرد"}, {"level": "warn", "path": "/برنامه-ریزی-کنکور/", "message": "title تغییر کرد"}],
  },
  wpOrganic: {
    "ok": true,
  ...
  techStatus: [
    ...
    { id: "robots", name: "robots.txt", status: "pass", detail: "موجود · sitemap ref ✓ · Sentinel 19:54" },
    { id: "sitemap", name: "XML Sitemap", status: "pass", detail: "sitemap_index.xml = 200 · Sentinel 19:54" },
