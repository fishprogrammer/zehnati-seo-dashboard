...
داشبورد SEO آکادمی ذهن آتی — نسخهٔ وب منتشرشده.
...
3. دکمهٔ **«انتشار آنلاین»** را بزنید  
...
روی نسخه آنلاین تیک‌ها **فقط‌خواندنی** از `data.js` هستند تا همان وضعیتی نمایش داده شود که با «انتشار آنلاین» فرستاده‌اید.
